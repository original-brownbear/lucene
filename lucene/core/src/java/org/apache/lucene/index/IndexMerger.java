...
public final class IndexMerger {
  ...
  /** Parse arguments. */
  @SuppressForbidden(reason = "System.out required: command line tool")
  static IndexMerger parseArgs(String[] args) throws IOException {
    String path = null;
    ...
    return new IndexMerger(dir, out, deletePriorCommits);
  }
   ...
   */
  public IndexMerger(Directory dir, InfoStream infoStream, boolean deletePriorCommits) {
   ...
   * older ones.
   */
  public IndexMerger(Directory dir, IndexWriterConfig iwc, boolean deletePriorCommits) {
    this.dir = dir;
    this.iwc = iwc;
