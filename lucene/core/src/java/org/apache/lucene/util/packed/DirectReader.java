    ...
    return switch (bitsPerValue) {
      case 1 -> index -> {
        try {
          ...
          return slice.readByte(index >>> 3) >>> shift & 0x1;
        } catch (IOException e) {
      ...
      case 2 -> index -> {
        try {
          ...
          return slice.readByte(index >>> 2) >>> shift & 0x3;
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      };
      case 4 -> index -> {
        try {
          ...
          return slice.readByte(index >>> 1) >>> shift & 0xF;
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      };
      case 8 -> index -> {
        try {
          return slice.readByte(index) & 0xFF;
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      };
      case 12 -> index -> {
        try {
          int shift = (int) (index & 1) << 2;
          return slice.readShort(index * 12 >>> 3) >>> shift & 0xFFF;
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      };
      case 16 -> index -> {
        try {
          return slice.readShort(index << 1) & 0xFFFF;
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      };
      case 20 -> index -> {
        try {
          int shift = (int) (index & 1) << 2;
          return slice.readInt(index * 20 >>> 3) >>> shift & 0xFFFFF;
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      };
      case 24 -> index -> {
        try {
          return slice.readInt(index * 3) & 0xFFFFFF;
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      };
      case 28 -> index -> {
        try {
          int shift = (int) (index & 1) << 2;
          return slice.readInt(index * 28 >>> 3) >>> shift & 0xFFFFFFF;
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      };
      case 32 -> index -> {
        try {
          return slice.readInt(index << 2) & 0xFFFFFFFFL;
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      };
      case 40 -> index -> {
        try {
          return slice.readLong(index * 5) & 0xFFFFFFFFFFL;
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      };
      case 48 -> index -> {
        try {
          return slice.readLong(index * 6) & 0xFFFFFFFFFFFFL;
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      };
      case 56 -> index -> {
        try {
          return slice.readLong(index * 7) & 0xFFFFFFFFFFFFFFL;
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      };
